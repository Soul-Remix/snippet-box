...
func (app *application) accountView(w http.ResponseWriter, r *http.Request) {
	...
	user, err := app.dbContext.users.Get(userId)
	if err != nil {
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.PermittedValue(form.Expires, 1, 7, 365), "title", "This field should be one of this values: 1, 7 or 365")
...
func (app *application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	userID := app.sessionManager.GetInt(r.Context(), "authenticatedUserID")
	err = app.dbContext.users.PasswordUpdate(userID, form.CurrentPassword,
		form.NewPassword)
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
